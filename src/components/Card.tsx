...
const Card:React.FC<ICard> = ({item,text,handleFunc}) => {
  return (
    <div className="w-10/12 sm:w-6/12 md:w-4/12 lg:w-3/12 min-h-[400px] max-h-[400px] flex flex-col justify-between bg-white rounded-lg ">
      <div className="p-4 ">
      ...
      <div className="flex justify-between items-center bg-blue-900 p-3">
        ...
        <button
          className="bg-gray-300 p-1 rounded-lg animate-bounce hover:animate-none"
